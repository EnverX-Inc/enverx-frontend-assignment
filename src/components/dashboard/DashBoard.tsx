...
export const Dashboard = () => {
  const { totalBalance, totalIncome, incomeChange, totalExpense, expenseChange } = useDashBoardCalcInformation();

  return (
    <Layout>
      <Stack alignItems="center" gap={4} width={{ xs: '100vw', md: '90%' }} sx={{ m: 'auto', my: 4 }}>
        ...
        >
          ...
          <ExpenseBox totalExpense={totalExpense} expenseChange={expenseChange} />
        </Stack>
        <TransactionTable />
      </Stack>
    </Layout>
